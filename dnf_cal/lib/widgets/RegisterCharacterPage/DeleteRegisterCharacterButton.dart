...
Widget DeleteRegisterCharacterButton(BuildContext context, String characterId) {
  if (context.watch<RegisterCharacterModel>().isEditing) {
    return Positioned(
      top: 0,
      right: 0,
      child: IconButton(
              ...
              builder: (context) {
                return AlertDialog(
                  ...
                  actions: [
                    ...
                    TextButton(
                        onPressed: () {
                          Provider.of<RegisterCharacterModel>(context,
                                  listen: false)
